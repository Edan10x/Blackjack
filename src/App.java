...
public class App {
        ...
        public static void main(String[] args) {
            ...
            while (true){
                // calling the function hitorstay.
                String response = hitOrStay();

                //checking if the user don't want another card.
                // if not it will break the loop.
                ...
                // if the player hand value is more than 21 the player loose
                if(handValue > 21){
        ...
        public static int drawRandomCard(){
            ...
            int randCard = rand.nextInt(1, 13);
